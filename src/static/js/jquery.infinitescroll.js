...
(function (factory) {
    ...
    $.infinitescroll.defaults = {
        loading: {
            finished: undefined,
            finishedMsg: "<em>There is no more items for showcase</em>",
    ...
    $.infinitescroll.prototype = {
        ...
        _create: function infscr_create(options, callback) {
            ...
            opts.callback = function(instance, data, url) {
                ...
                if (opts.prefill) {
                    $window.off('resize.infinite-scroll').on('resize.infinite-scroll', instance._prefill);
                }
            };
        ...
        _prefill: function infscr_prefill() {
            ...
            this._prefill = function() {
                ...
                $window.off('resize.infinite-scroll').on('resize.infinite-scroll', function() {
                    if (needsPrefill()) {

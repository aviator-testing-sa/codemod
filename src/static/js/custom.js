...
!function () {
  function t() { }
  function e(t) { return r.retinaImageSuffix + t }
  function i(t, i) {
  ...
  function n(t) {
    ...
    var e = this; this.path.check_2x_variant(function (t) { t && e.swap() })
  }
  ...
  a.Retina = t, t.configure = function (t) {
    ...
    t.onload = function () {
      ...
      for (t = 0; t < a.length; t += 1) i = a[t], i.getAttributeNode("data-no-retina") || r.push(new n(i)); e()
    }
  }, t.isRetina = function () {
    var t = "(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)";
    return a.devicePixelRatio > 1 ? !0 : a.matchMedia && a.matchMedia(t).matches ? !0 : !1
  };
  var o = /\.\w+$/; a.RetinaImagePath = i, i.confirmed_paths = [], i.prototype.is_external = function () { return !(!this.path.match(/^https?\:/i) || this.path.match("//" + document.domain)) }, i.prototype.check_2x_variant = function (t) {
    var e, n = this; return this.is_external() ? t(!1) : this.perform_check || "undefined" == typeof this.at_2x_path || null === this.at_2x_path ? this.at_2x_path in i.confirmed_paths ? t(!0) : (e = new XMLHttpRequest, e.open("HEAD", this.at_2x_path), e.onreadystatechange = function () {
    ...
    } "undefined" == typeof t && (t = this.path.at_2x_path); var i = this; e()
  }, t.isRetina() && t.init(a)
}();
  ...
  e = (function () {
    ...
    t.prototype.createEvent = function (t, e, n, i) {
      ...
      return null != document.createEvent
        ? ((o = document.createEvent("CustomEvent")), o.initCustomEvent(t, e, n, i))
  ...
  i =
    ...
    function (t, e) {
      this.getPropertyValue = function (e) {
        ...
        return (null != (n = t.currentStyle) ? n[e] : void 0) || null;
      };
      return this;
    };
  o = /(\-([a-z]){1})/g;
  this.WOW = (function () {
    ...
    o.prototype.start = function () {
      ...
      (this.boxes = (function () {
        let t, n, i, o;
        for (
          i = this.element.querySelectorAll("." + this.config.boxClass), o = [], t = 0, n = i.length;
          n > t;
          t++
        )
          (e = i[t]), o.push(e);
    ...
    o.prototype.doSync = function (t) {
      ...
      if ((null == t && (t = this.element), 1 === t.nodeType)) {
        for (
          t = t.parentNode || t, o = t.querySelectorAll("." + this.config.boxClass), r = [], n = 0, i = o.length;
          i > n;
          n++
        )
          (e = o[n]),
